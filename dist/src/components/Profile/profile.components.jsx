export const Badge = ({ icon = null, logoSrc = null, alt = "Favorite Club icon", title, subtitle, diraction = "l" }) => {
    return (<div className={`text-[#5f5f5f] w-[calc(33.33vw-16px)]- w-full items-center flex text-sm gap-2 ${diraction == "r" ? "justify-end" : diraction == "c" ? "justify-center" : "justify-start"} `}>
...
//# sourceMappingURL=profile.components.jsx.map