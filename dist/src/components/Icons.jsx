...
// }
export const HomeIcon = ({ className = "", onClick = () => { } }) => {
    return (<div onClick={onClick} className={`cursor-pointer ${className}`}>
...
export const LogoutIcon = ({ className = "", onClick = () => { } }) => {
    return (<div onClick={onClick} className={`cursor-pointer ${className}`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Following-1--Streamline-Ultimate" height="24" width="24">
                ...
                <path fill="#29af91" fillRule="evenodd" clipRule="evenodd" d="M10.264 9.757a4.752 4.752 0 1 0 0 -9.504 4.752 4.752 0 0 0 0 9.504Zm.19 9.804c0 .569.172 1.097.467 1.535H1.484c-.575 0-1.036-.486-.94-1.053.753-4.424 4.55-8.18 9.715-8.18 2.82 0 5.231 1.118 6.963 2.853a2.498 2.498 0 0 0-.437 1.412v.683h-3.582a2.75 2.75 0 0 0-2.75 2.75Zm8.081-1.25V16.13a.75.75 0 0 1 1.28-.53l3.435 3.433a.75.75 0 0 1 0 1.061l-3.434 3.434a.75.75 0 0 1-1.28-.53v-2.186h-5.333a1.25 1.25 0 0 1 0-2.5h5.332Z" strokeWidth="1"/>
            </svg>
        </div>);
};
export const TrashIcon = ({ className = "", onClick = () => { } }) => {
    return (<div onClick={onClick} className={`cursor-pointer ${className}`}>
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="Delete--Streamline-Ultimate" height="24" width="24">
                ...
                <path d="M0.5 12a11.5 11.5 0 1 0 23 0 11.5 11.5 0 1 0 -23 0Z" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1"/>
                <path d="M3.869 20.131 20.131 3.869" fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1"/>
            </svg>
        </div>);
};
