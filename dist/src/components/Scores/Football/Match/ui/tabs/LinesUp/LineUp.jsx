...
const LineUpTab = ({ isActive, matchId }) => {
    // const matchContext = useFootballMatch();
    const [isLoading, setisLoading] = useState(true);
    const [linesup, setlinesup] = useState();
    ...
    if (!isActive)
        return <></>;
    return (<LinesUpUI linesup={linesup} error={error} isLoading={isLoading}/>);
};
export default LineUpTab;
//# sourceMappingURL=LineUp.jsx.map