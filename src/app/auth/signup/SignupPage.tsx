    ...
    return (
        ...
        Sportigon
            ...
            <input
                ...
                required
                pattern={`^[a-zA-Z0-9_]{${userConfig.minUsernameLength},${userConfig.maxUsernameLength}}$`}
                title={`Username must be between ${userConfig.minUsernameLength} and ${userConfig.maxUsernameLength} characters long and can only contain letters, numbers, and underscores.`}
            />
            <input
                type="text"
                className="bg-gray-100 focus:bg-white rounded-md border border-gray-300 focus:border-[#007600] focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
        ...
        Use phone instead?
            ...
            <input
                ...
                value={password}
                required
                minLength={userConfig.minPasswordLength}
                maxLength={userConfig.maxPasswordLength}
            ...
            <BigButton
                ...
                isProcessing={isSubmitting} // Replace with actual processing state if needed
            />
