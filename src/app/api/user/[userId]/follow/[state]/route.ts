...
const updateTheFollowersAndFollowing = async (state: "1" | "0", userId: string | mongoose.Types.ObjectId, targetUserId: IUser | mongoose.Types.ObjectId) => {
