...
export type MediaFile = { filetype: string; file?: File; url?: string };
...
const NewPostPage = () => {
    ...
    const characterCountRef = useRef<HTMLSpanElement>(null);
    ...
    const isValidBackgroundPost = () => {
        if (caption.length > CHAR_LIMIT_WITH_BG) return false;
    ...
    const setActivity = (active: boolean, isForce?: boolean | null) => {
    ...
    return (
        <>
            ...
            >
                <section
                    className="flex flex-col w-full py-2 h-full  rounded-xl"
                >
                    ...
                    <div className="flex items-center px-2 justify-between">
                        ...
                        <div className="flex gap-3 CATAGORY_ELEMENT">
                            <div
                                className="relative CATAGORY_ELEMENT min-w-32"
                                onClick={(e) => {
                    ...
                    <section
                        className={` w-full flex-col  ${MediaFilesUtils.isMediaMode() && !isValidBackgroundPost() ? 'min-h-[80%]' : 'h-[100%]'} min-h-[2rem]- relative flex mt-3 ${!isValidBackgroundPost() ? "px-2-" : "px-0"
                            }`}
                    >
                        ...
                        <div className={`bg-purple-600- relative- ${MediaFilesUtils.isMediaMode() && !isValidBackgroundPost() ? 'h-full- h-fit' : 'h-full-'}`}>
                            ...
                            >
                                {!caption && (
                                    <p
                                        className={` absolute pointer-events-none INPUT_BOX w-full ${isValidBackgroundPost()
                                ...
                                <div
                                    ...
                                    className={`outline-none  max-h-16- ${MediaFilesUtils.isMediaMode() ? ' p-2 overflow-x-auto whitespace-nowrap- text-nowrap-' : ''}  scrollbar-none w-full ${isValidBackgroundPost() ? "text-2xl rounded-3xl" : "min-h-28  bg-[#ececec] rounded-xl py-2 px-3 max-h-64 overflow-auto"}`}
                                    onInput={(e) => {
                                        onInput(e)
                                    }}
                        ...
                        <section className="flex flex-col absolute- border-t border-[rgba(0,0,0,0.1)] mt-4 bottom-1- w-full left-0- bg-white- bg-yellow-600- px-2- py-2">
                            <div
                                ...
                                className="flex relative items-center px-2- gap-1 w-full"
                            >
                                    ...
                                    {backgroundThemes.map((bg, i) => {
                                        return <div
                                            ...
                                            onScroll={e => {
                                                ...
                                                if (colorCardContainerTotalScrollPosition != totalScrollWidth) setColorCardContainerTotalScrollPosition(totalScrollWidth);
                                                    ...
                                                    return (
                                                        <div
                                                            ...
                                                            className={`${currentBackgroundChoosen === theme ? "border-2" : ""
                                                                }  aspect-square border-[#585858] overflow-hidden shadow-md min-w-[32px] cursor-pointer flex items-center justify-center rounded-lg`}
                                                        >
