...
export interface IUser extends mongoose.Document {
    ...
    loginTokens: Array<{
        ...
        socket_id?: string; // For real-time features
    ...
    // blockedUsers?: mongoose.Types.ObjectId[]; // Array of User IDs
    followersCount?: number; // Number of followers
    followingCount?: number; // Number of users this user is following
    favoriteSports?: string[]; // Array of favorite sports
    favoriteTeams?: mongoose.Types.ObjectId[]; // Array of Team IDs
    favoritePlayers?: mongoose.Types.ObjectId[]; // Array of Player IDs
    notificationSettings?: {
        likes?: boolean;
        comments?: boolean;
        follows?: boolean;
        messages?: boolean;
        securityAlerts?: boolean; // For login attempts
    };
    lastLogin?: Date;
    isVerified?: boolean;
    isActivityStatusShowing?: boolean;
    accountType?: "personal" | "business"; // personal or business account
    accountSuspensions?: number; // Number of times the account has been suspended
